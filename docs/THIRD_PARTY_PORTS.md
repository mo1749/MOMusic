...
## MOMusic-LX-Music desktop/home reference

- Upstream: `ww085213/MOMusic-LX-Music`
...
MOMusic's full desktop mode adapts the upstream idea of moving the existing
...
implemented against MOMusic's existing provider, weather-radio, local-library,
