var LYRIC_TIMING_OFFSET_STORE_KEY = 'MOMusic-lyric-timing-offsets-v1';
...
function handleLyricTimingOffsetClick(e) {
  if (e && e._MOMusicLyricTimingHandled) return;
  ...
  if (e) {
    e._MOMusicLyricTimingHandled = true;
    e.preventDefault();
    e.stopPropagation();
  }
...
function bindLyricTimingOffsetControls() {
  var root = document.getElementById('lyric-timing-control');
  if (!root || root._MOMusicLyricTimingBound) return;
  root._MOMusicLyricTimingBound = true;
