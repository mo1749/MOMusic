...
function updateDevelopmentFxControls() {
  [
    ...
    ['wallpaperMode', 't-wallpaperMode', '把完整 MOMusic 放到 Windows 桌面；右上控制器可显示、隐藏桌面图标；Esc 退出；重启默认关闭']
...
function updateFxInputs() {
  ...
  setRange('fx-goldencoreglow', fx.goldenCoreGlow == null ? fxDefaults.goldenCoreGlow : fx.goldenCoreGlow);
  setRange('fx-goldencoreorbitcount', fx.goldenCoreOrbitCount == null ? fxDefaults.goldenCoreOrbitCount : fx.goldenCoreOrbitCount);
  setRange('fx-goldencoreorbitsize', fx.goldenCoreOrbitSize == null ? fxDefaults.goldenCoreOrbitSize : fx.goldenCoreOrbitSize);
  setRange('fx-goldencoredensity', fx.goldenCoreDensity == null ? fxDefaults.goldenCoreDensity : fx.goldenCoreDensity);
  setRange('fx-goldencorespin', fx.goldenCoreSpin == null ? fxDefaults.goldenCoreSpin : fx.goldenCoreSpin);
  setRange('fx-goldencorestardust', fx.goldenCoreStardust == null ? fxDefaults.goldenCoreStardust : fx.goldenCoreStardust);
  setRange('fx-goldencorebreath', fx.goldenCoreBreath == null ? fxDefaults.goldenCoreBreath : fx.goldenCoreBreath);
  setRange('fx-treecanopyglow', fx.treeCanopyGlow == null ? fxDefaults.treeCanopyGlow : fx.treeCanopyGlow);
  setRange('fx-treecanopywind', fx.treeCanopyWind == null ? fxDefaults.treeCanopyWind : fx.treeCanopyWind);
  setRange('fx-treecanopysway', fx.treeCanopySway == null ? fxDefaults.treeCanopySway : fx.treeCanopySway);
  setRange('fx-treecanopystaffcount', fx.treeCanopyStaffCount == null ? fxDefaults.treeCanopyStaffCount : fx.treeCanopyStaffCount);
  setRange('fx-treecanopynotedensity', fx.treeCanopyNoteDensity == null ? fxDefaults.treeCanopyNoteDensity : fx.treeCanopyNoteDensity);
  ...
  var pixelKaomojiToggle = document.getElementById('t-pixelKaomojiEnabled');
  if (pixelKaomojiToggle) pixelKaomojiToggle.classList.toggle('on', fx.pixelKaomojiEnabled !== false);
  var pixelKaomojiLyricsToggle = document.getElementById('t-pixelLyricsEnabled');
  if (pixelKaomojiLyricsToggle) pixelKaomojiLyricsToggle.classList.toggle('on', fx.pixelLyricsEnabled !== false);
  var pixelKaomojiLyricsPanelToggle = document.getElementById('t-pixelKaomojiLyricsPanel');
  if (pixelKaomojiLyricsPanelToggle) pixelKaomojiLyricsPanelToggle.classList.toggle('on', fx.pixelKaomojiLyrics !== false);
  ...
  if (typeof updateGoldenCoreColorControls === 'function') updateGoldenCoreColorControls();
  if (typeof updatePixelKaomojiColorControls === 'function') updatePixelKaomojiColorControls();
...
function relabelFxPanelControls() {
  ...
  setFxSectionBefore('fx-goldencoreglow', '几何能量核心');
