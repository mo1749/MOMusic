...
function ensureSonicWorkshopCoverPaletteForUi() {
  ...
  img.onload = function () {
    ...
    try {
      ...
      if (window.MOMusicSonicWorkshop && typeof MOMusicSonicWorkshop.pushProperties === 'function') MOMusicSonicWorkshop.pushProperties(true);
    } catch (e) {
...
function pushSonicWorkshopColorChange(reason) {
  updateSonicWorkshopColorControls();
  var workshop = window.MOMusicSonicWorkshop;
