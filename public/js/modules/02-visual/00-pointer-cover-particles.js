...
window.addEventListener('mouseup', function (e) {
  ...
  idleGuidePointerUp();
  if (window.MOMusicSonicTopography && MOMusicSonicTopography.isActive(fx) && !mouseDownAt.hadDrag && !isPointerOverUi(e)) {
    ...
    MOMusicSonicTopography.pointerRipple(nx, nz, strength);
  }
});
