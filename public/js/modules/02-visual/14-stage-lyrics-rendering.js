...
function cancelStageLyricPrewarmBuildOnly() {
  ...
  if (typeof window !== 'undefined' && window.__MOMusicLyricBuildStats) {
    window.__MOMusicLyricBuildStats.active = false;
  }
}
...
function cancelStageLyricResidentBuild() {
  ...
  if (typeof window !== 'undefined' && window.__MOMusicLyricResidentStats) {
    window.__MOMusicLyricResidentStats.active = false;
  }
}
...
function finishStageLyricResidentBuild(job) {
  ...
  if (typeof window !== 'undefined') {
    window.__MOMusicLyricResidentStats = {
...
function updateStageLyricBuildStats(job, active, chunkMs) {
  ...
  var stats = window.__MOMusicLyricBuildStats || {};
  ...
  window.__MOMusicLyricBuildStats = stats;
}
...
function startStageLyricCooperativePrewarm(payload, key, token, lightweight, reason) {
  ...
  if (typeof window !== 'undefined') {
    window.__MOMusicLyricBuildStats = {
      active: true,
      reason: job.reason,
