...
function disposeOwnedLyricTexture(texture) {
  if (!texture || !texture.userData || !texture.userData.__MOMusicLyricOwned || texture.userData.__MOMusicDisposed) return;
  texture.userData.__MOMusicDisposed = true;
  texture.dispose();
}
...
function flushLyricDisposeQueue() {
  ...
  if (typeof window !== 'undefined') {
    window.__MOMusicLyricDisposeStats = {
...
function disposeLyricMesh(mesh) {
  if (!mesh || mesh.userData && mesh.userData.__MOMusicDisposeQueued) return;
  mesh.userData = mesh.userData || {};
  mesh.userData.__MOMusicDisposeQueued = true;
