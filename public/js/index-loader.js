...
(function loadMOMusicIndexModules() {
  ...
  const modulePaths = [
    ...
    'js/modules/05-playback/08a-audio-fx.js',
    ...
    'js/modules/05-playback/21-custom-lx-source.js',
    ...
    'js/modules/08-account/06-red-dust-inn.js',
    ...
    'js/modules/10-shell/04a-desktop-bar-position.js',
  ...
  function readModule(path) {
    ...
    if ((request.status < 200 || request.status >= 300) && request.status !== 0) {
      throw new Error('Failed to load MOMusic module: ' + path + ' (' + request.status + ')');
    }
