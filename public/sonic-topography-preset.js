/**
 * Sonic Topography visual preset for MOMusic.
 * Visual algorithm ported from yin-yizhen/sonic-topography 1.1.1 (commit 3ff303e).
 * Only the visual layer is embedded here; player, login and server logic stay MOMusic-native.
 */
(function (global) {
  'use strict';
  ...
  function update(dt, ctx) {
    ...
    var audio = readMOMusicAudio(ctx.audio || {});
