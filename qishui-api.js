...
const QISHUI_UA = 'MOMusic/2.0.2 (Qishui official OpenAPI bridge)';
...
const QISHUI_PUBLIC_HEADERS = {
  ...
  'User-Agent': 'MOMusic/2.0.2 (Qishui public catalog bridge)',
};
  ...
  return {
    ...
    message: webSession
      ...
      : (QISHUI_PUBLIC_ENABLED
        ? '请先登录本机汽水音乐 PC 客户端，再由 MOMusic 读取本地会话；未导入时仅保留公开搜索匹配。'
        : '请先登录本机汽水音乐 PC 客户端，再由 MOMusic 读取本地会话。'),
  };
}
