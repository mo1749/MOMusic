...
async function run() {
  ...
  assert(localImportSource.indexOf('readQishuiOfficialClientCookieHeader()') < localImportSource.indexOf('readSavedQishuiCookieHeader()'), 'fresh SodaMusic state must be read before the cached MOMusic copy');
